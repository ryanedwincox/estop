...
(cl:defmethod cl:initialize-instance :after ((m <estopSignal-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'estopSignal-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name estop-srv:<estopSignal-request> is deprecated: use estop-srv:estopSignal-request instead.")))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <estopSignal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader estop-srv:message-val is deprecated.  Use estop-srv:message instead.")
  (message m))
...
(cl:defmethod cl:initialize-instance :after ((m <estopSignal-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'estopSignal-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name estop-srv:<estopSignal-response> is deprecated: use estop-srv:estopSignal-response instead.")))

(cl:ensure-generic-function 'handshake-val :lambda-list '(m))
(cl:defmethod handshake-val ((m <estopSignal-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader estop-srv:handshake-val is deprecated.  Use estop-srv:handshake instead.")
  (handshake m))
